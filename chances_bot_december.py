        ...
        try:
            ...
            if ':chances' in message.content:
                ...
                fail_lst = (
                    ...
                    f'Looks like the dreidel didn\t spin quite your way <@{author}>.  I picked {comp_num} and you picked {usr_arg}!',
                    f'Hey, <@{author}>, looks like the odds aren\'t with people on the naughty list. I picked {comp_num} and you picked {usr_arg}!'
                )
                ...
                success_lst = (
                    ...
                    f'<@{author}>! You did it! Have a happy holiday season with all that luck you\'ve built up! I picked {comp_num} and you picked {usr_arg}!',
                    f'<@{author}> has the spirit! Nice job and enjoy your holidays! I picked {comp_num} and you picked {usr_arg}!'
                )
