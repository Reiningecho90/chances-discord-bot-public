        ...
        try:
            ...
            if ':chances' in message.content:
                ...
                fail_lst = (
                    ...
                    f'Let\'s hope that 2022 is better than your luck <@{author}>.  I picked {comp_num} and you picked {usr_arg}!',
                    f'You\'re not a pro gamer <@{author}>, maybe it\'ll happen in 2022.  I picked {comp_num} and you picked {usr_arg}!',
                    f'2022 might not be your year <@{author}>.  I picked {comp_num} and you picked {usr_arg}!',
                    f'Hmmm, <@{author}> you seem to have picked the wrong number, at least theres more days in 2022!  I picked {comp_num} and you picked {usr_arg}!',
                )
                ...
                success_lst = (
                    ...
                    f'Happy 2022 <@{author}> you chose the correct number!  I picked {comp_num} and you picked {usr_arg}!',
                    f'2022 is the year of the (your) gambling addiction <@{author}>! Please dont hurt me...  I picked {comp_num} and you picked {usr_arg}!',
                    f'Well, 2022 is doing you good <@{author}>!  I picked {comp_num} and you picked {usr_arg}!',
                    f'<@{author}>, you won! Makes 2022 look a whole lot better doesn\'t it?  I picked {comp_num} and you picked {usr_arg}!',
                )
